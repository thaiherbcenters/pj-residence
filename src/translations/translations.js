const translations = {
    th: {
        ...
        accommodations: {
            ...
            govOfficial: 'ข้าราชการ/รัฐวิสาหกิจ (680 บาท/คืน)',
            govSub: '(*โปรดแสดงบัตร)',
            googleReview: 'รีวิว Google Map 5 ดาว (680 บาท/คืน)',
            perNight: '/คืน',
    ...
    en: {
        ...
        accommodations: {
            ...
            govOfficial: 'Gov. Official (680 THB/night)',
            govSub: '(*Show ID)',
            googleReview: 'Google Map 5-Star Review (680 THB/night)',
            perNight: '/night',
    ...
    cn: {
        ...
        accommodations: {
            ...
            viewDetails: '查看详情',
            govOfficial: '公务员/国企员工 (680 泰铢/晚)',
            govSub: '(*请出示证件)',
            googleReview: '谷歌地图 5 星好评 (680 泰铢/晚)',
            perNight: '/晚',
            viewAllRooms: '查看所有客房',
            perMonth: '/月',
            rooms: [
